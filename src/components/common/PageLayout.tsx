          ...
          {showSearch && 
            <label className="order-3 relative block basis-full md:order-2 md:basis-auto md:w-full md:min-w-[300px] md:max-w-[750px] md:justify-self-center">
              ...
              <input
                ...
                className="h-11 w-full rounded-full border border-white/45 bg-white/10 pl-11 pr-4 text-[0.9rem] text-text-primary shadow-[0_10px_24px_rgba(15,23,42,0.06),inset_0_1px_0_rgba(255,255,255,0.8)] backdrop-blur-xl outline-none transition-[border-color,background-color,box-shadow] duration-200 placeholder:font-semibold placeholder:text-[rgba(72,72,73,0.7)] focus:border-white/60 focus:bg-white/48 focus:shadow-[0_10px_26px_rgba(15,23,42,0.08),inset_0_1px_0_rgba(255,255,255,0.88)]"
              />
            </label>}
